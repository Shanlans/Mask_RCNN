...
ROOT_DIR = 'folder_merged'
IMAGE_DIR = os.path.join(ROOT_DIR, "train2018")
ANNOTATION_DIR = os.path.join(ROOT_DIR, "annotations")

INFO = {
    "description": "Example Dataset",
    "url": "https://github.com/Shanlans",
    "version": "0.1.0",
    "year": 2018,
    "contributor": "shenshanlan",
...
def main():
    ...
    with open('{}/annotations/shuijing_train2018.json'.format(ROOT_DIR), 'w') as output_json_file:
